# ![https://mouredev.com](https://raw.githubusercontent.com/mouredev/mouredev/master/mouredev_emote.png) Hola, mi nombre es Sem Perez Lizano 👋
### Network engineer & Android engineer
...
Soy ingeniero de redes desde 2020.

He trabajado en distintas multinacionales del sector, brindando soporte tecnico a infraestrucutura multivendor (Cisco, Mikrotik, Fortinet, SonicWall, Sophos XG, etc) y desarrollo de proyectos de intalacion y levantamiento de servicios empresariales a usuarios finales y corporativos. Me especializo en la implementacion y troublesoot de inscidencias logicas de los equipos de red y Servidores de distintas distribuciones como Red Hat, Debian, Fedora, Windows Server 2016, Solar Wind.
cuento con certificaciones internaconales como: MikroTik Certified Network Associate, CCNAv7, Rukus Administrator SmartZone, Rukus Acredited ICX Iplementer 
